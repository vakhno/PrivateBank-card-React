			...
			<div className='main'>
				<div className='main__content'>
					<div className='main__info'>
						...
						<Link to='/places' className='main__feature link-default'>
						...
						<Link to='/calculator' className='main__feature link-default'>
							<div className='main__feature-info'>
						...
						<Link to='/currency' className='main__feature link-default'>
							<div className='main__feature-info'>
